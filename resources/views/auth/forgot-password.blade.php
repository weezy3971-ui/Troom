...
<head>
    ...
    <title>Reset password — Trooms House</title>
...
<body>
    <div class="login-card">
        ...
        <p class="subtitle">Enter your email and the phone number on your account. We'll text you a code to confirm it's you.</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="phone" name="phone" value="{{ old('phone') }}" placeholder="07XX XXX XXX" inputmode="tel" autocomplete="tel" required>
            </div>
