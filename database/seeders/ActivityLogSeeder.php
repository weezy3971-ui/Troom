...
class ActivityLogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $entries = [
            ...
            // ── Crop Cycles ─────────────────────────────────────────────
            ['days' => 60, 'user' => $agronomist, 'action' => 'created', 'subject' => CropCycle::where('season_name','Long Rains 2026')->first(), 'desc' => 'Created Crop Cycle: Long Rains 2026 — Capsicum (California Wonder) on Block A, planted 1 Mar 2026'],
            ['days' => 55, 'user' => $agronomist, 'action' => 'created', 'subject' => CropCycle::where('season_name','Main Crop 2026')->first(), 'desc' => 'Created Crop Cycle: Main Crop 2026 — Spinach (Fordhook Giant) on Block D, planted 15 May 2026'],
            ['days' => 30, 'user' => $manager,    'action' => 'created', 'subject' => CropCycle::where('season_name','Q3 2026')->first(), 'desc' => 'Created Crop Cycle: Q3 2026 — Collard Greens (Thousand Headed) on Block C, planned for Jul–Oct 2026'],
            ...
            ['days' =>  5, 'user' => $agronomist, 'action' => 'created', 'subject' => CropCycle::where('season_name','Q4 2026')->first(), 'desc' => 'Created Crop Cycle: Q4 2026 — African Nightshade (Giant Nightshade) on Block E, planting Sep 2026'],
            ...
            ['days' => 53, 'user' => $finance,    'action' => 'created', 'subject' => SeasonalBudget::skip(1)->first(), 'desc' => 'Created Seasonal Budget: Main Crop 2026 Spinach — KES 400,000 approved'],
            ...
            ['days' => 12, 'user' => $storekeeper,'action' => 'created', 'subject' => InventoryTransaction::where('reference','ISS-2002')->first(), 'desc' => 'Issued from store: CAN 26% Nitrogen — 90 kg to Main Crop 2026 Spinach cycle, ISS-2002'],

            // ── Harvest ──────────────────────────────────────────────────
            ['days' =>  2, 'user' => $supervisor, 'action' => 'created', 'subject' => HarvestBatch::where('quantity_kg',1200)->first(), 'desc' => 'Recorded Harvest Batch: 1,200 kg Capsicum (Grade A), 80 kg rejects — Block A Greenhouse 1, 8 Jul 2026'],
            ['days' =>  1, 'user' => $supervisor, 'action' => 'created', 'subject' => HarvestBatch::where('quantity_kg',900)->first(), 'desc' => 'Recorded Harvest Batch: 900 kg Spinach (Grade A), 40 kg rejects — Block D North, 9 Jul 2026'],
            ['days' =>  1, 'user' => $supervisor, 'action' => 'created', 'subject' => HarvestBatch::where('quantity_kg',1050)->first(), 'desc' => 'Recorded Harvest Batch: 1,050 kg Capsicum (Grade B), 130 kg rejects — Block A second pick, 9 Jul 2026'],
            ...
            ['days' =>  1, 'user' => $supervisor, 'action' => 'created', 'subject' => PackhouseLot::where('lot_number','LOT-0004')->first(), 'desc' => 'Packed Lot LOT-0004: 700 units × 4kg export carton from Grade B capsicum pick'],
            ...
            // ── Sales Orders ──────────────────────────────────────────────
            ['days' =>  2, 'user' => $sales,      'action' => 'created', 'subject' => SalesOrder::where('status','allocated')->first(), 'desc' => 'Created Sales Order #1: FreshMart Europe Ltd — 800 kg Capsicum, delivery 12 Jul 2026, LOT-0001 allocated'],
            ['days' =>  1, 'user' => $sales,      'action' => 'created', 'subject' => SalesOrder::where('status','fulfilled')->first(), 'desc' => 'Created Sales Order #2: Nairobi Grocers Co-op — 700 kg Capsicum (Grade B), delivery 10 Jul 2026'],
            ...
            ['days' =>  1, 'user' => $sales,      'action' => 'created', 'subject' => SalesOrder::where('status','pending')->first(), 'desc' => 'Created Sales Order #3: FreshMart Europe Ltd — 500 kg Collard Greens pending, delivery in 3 days (no stock allocated yet)'],
